    ...
    <div className="min-h-screen bg-gray-950 text-white flex">
      ...
      <div className="flex-1 px-8 py-8 overflow-auto">
        ...
        <div className="grid grid-cols-4 gap-4 mb-8">
          {[
            { label: 'Total patients', value: totalPatients ?? 0, color: '' },
            { label: 'Total appointments', value: totalAppointments ?? 0, color: '' },
            { label: 'Active treatments', value: activetreatments ?? 0, color: '' },
            { label: 'Pending payments', value: pendingPayments ?? 0, color: 'text-yellow-400' },
          ].map((stat) => (
